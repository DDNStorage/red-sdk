 ...
 *
 ******************************************************************************/
#ifndef COMMON_STRING_UTILS_HPP_
#define COMMON_STRING_UTILS_HPP_
 ...
 */
void split_tensubten(char const *ten_subten, char **tenant, char **subtenant);
} // namespace common

#endif // COMMON_STRING_UTILS_HPP_
